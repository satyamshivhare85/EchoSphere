...
//         <button
//           type="submit"
//           className="h-[35px] px-3 rounded-full border-2 border-blue-500 text-blue-400 hover:bg-blue-500 hover:text-white transition w-[120px]"
//         >
//           Add
//         </button>
//       </form>
...
//           displayItem={(e) => `${e.institution} | ${e.degree} | ${e.fieldOfStudy}`}
//         />
...
//           displayItem={(e) => `${e.role} | ${e.company} | ${e.startDate ? new Date(e.startDate).toLocaleDateString() : ""} - ${e.endDate ? new Date(e.endDate).toLocaleDateString() : ""}`}
//         />
...
//           fields={["title", "description", "link", "technologies"]}
//           placeholder="Projects"
//           displayItem={(p) => `${p.title} | ${p.link || ""}`}
//         />
